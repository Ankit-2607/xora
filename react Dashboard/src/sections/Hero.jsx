            ...
            <Element name="hero">
                ...
                <div className="container">
                    <div className="relative z-2 max-w-512 max-lg:max-w-388">
                        ...
                        <p className="max-w-440 mb-14 body-1 max-md:mb-10"> We design XORA AI Video Editor to be an easy to use , quick to learn and surprisingly powerful. </p>
                    </div>
                ...
                <div className="absolute -top-32 left-[calc(50%-340px)] w-[1230px] pointer-events-none hero-img_res">
                    <img
                        src="/images/hero.png" className="size-1230 max-lg:h-auto"
                    />
                </div>
